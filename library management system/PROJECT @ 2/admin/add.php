  ...
  <span style="font-size:30px; cursor:pointer; color:black;" onclick="openNav()">&#9776; open</span>
    <div class="container">
      ...
      <form class="book" action="" method="post">
        ...
        <input type="text" name="author" class="form-control" placeholder="Author's Name" required=""><br><br>
        ...
        <button style="text-align: center;" class="block" type="submit" name="submit">ADD</button>
    </form>
    </div>
    <?php
